...
from backend.routes import agents, auth, billing, pipeline, router as router_routes, planner, leadfinder, wan, social, brain, apikeys
...
async def lifespan(app: FastAPI):
    ...
    from backend.mcp_server import start_mcp_server
    start_mcp_server()
    yield
    close_llm()
    close_router_llm()
